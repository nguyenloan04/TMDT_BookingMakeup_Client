...
export default function SoDashboard({ userId }: SoDashboardProps) {
  ...
  const fetchReviewsList = async () => {
    try {
      ...
      // Reviews are non-blocking for the main dashboard.
    }
  };
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      toast.error(getErrorMessage(e, "Lỗi cập nhật thông tin"));
    } finally {
  ...
  const handleDeleteService = async (id: string) => {
    ...
    try {
      ...
      toast.error(getErrorMessage(e, "Không thể xóa dịch vụ"));
    }
  };
